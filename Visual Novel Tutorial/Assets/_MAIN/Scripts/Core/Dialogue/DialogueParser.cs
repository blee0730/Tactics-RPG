...
public class DialogueParser
{
    ...
    public static DIALOGUE_LINE Parse(string rawLine)
    {
        ...
        //We have to inject tags and variables into the speaker and dialogue spearately beacuse there are initial checks that have to be performed
        //But commands need no checks, so we can just inject the variables in them right now.
