...
public class CMD_Database_Extension_Audio : CMD_DatabaseExtension
{
    ...
    private static void PlaySFX(string[] data)
    {
        ...
        //Try to get the name or the path to the sound effect
    ...
    private static void PlaySong(string[] data)
    {
        ...
        //Try to get the channel for the track
    ...
    public static void PlayTrack(string filepath, int channel, CommandParameters parameters)
    {
        bool loop;
        float volumeCap;
        float startVolume;
