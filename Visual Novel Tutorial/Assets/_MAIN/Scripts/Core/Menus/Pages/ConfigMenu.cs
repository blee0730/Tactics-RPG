...
public class ConfigMenu : MenuPage
{
    ...
    public void SetSFXVolume()
    {
        ...
        ui.sfxFill.color = config.musicMute ? UI_ITEMS.musicOffColor : UI_ITEMS.musicOnColor;
    ...
    public void SetVoicesVolume()
    {
        ...
        ui.voicesFill.color = config.musicMute ? UI_ITEMS.musicOffColor : UI_ITEMS.musicOnColor;
