...
public class DialogueSystem : MonoBehaviour
{
    ...
    {
        if (config == null)
            config = CharacterConfigData.Default;

        dialogueContainer.SetDialogueColor(config.SafeDialogueColor);
        dialogueContainer.SetDialogueFont(config.SafeDialogueFont);
        dialogueContainer.SetDialogueFontSize(config.SafeDialogueFontSize * this.config.dialogueFontScale);
        dialogueContainer.nameContainer.SetNameColor(config.SafeNameColor);
        dialogueContainer.nameContainer.SetNameFont(config.SafeNameFont);
        dialogueContainer.nameContainer.SetNameFontSize(config.SafeNameFontSize);
    }
