...
public class HistoryLogManager : MonoBehaviour
{
    ...
    private const float TEXT_DEFAULT_SCLAE = 1f;
    ...
    private void CreateLog(HistoryState state)
    {
        ...
        else
        {
            ...
            log.nameFontSize = TEXT_DEFAULT_SCLAE * state.dialogue.speakerSize;
        ...
        log.dialogueFontSize = TEXT_DEFAULT_SCLAE * state.dialogue.dialogueSize;
