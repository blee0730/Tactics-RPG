...
public class AbilityTargetState : BattleState 
{
	...
	protected override void OnFire (object sender, InfoEventArgs<int> e)
	{
		if (e.info == 0)
		{
			if (aa.counter >= 1 && (ar.directionOriented || tiles.Contains(board.GetTile(pos))))
			{
				aa.counter--;
				aa.tiles.Add(board.GetTile(pos));
				if (aa.counter == 0 && (ar.directionOriented || tiles.Contains(board.GetTile(pos))))
